function [candidates_number_matrix,candidates_matrix] = candidates_matrix(original_matrix)
...
candidates_matrix = zeros(row_length,row_length,row_length)
...
for i = 1:row_length
    for j = 1:row_length
        if original_matrix(i,j) == 0
            ...
            candidates_matrix(i,j,1:length(candidates)) = candidates;
        end
    end
end
end
